    ...
    <div className="About">
      <div id='form mb-10'>
        <div className="title mb-2 px-1_5">
            ...
            <input className='border-l-0 border-r-0 border-t-0 outline_line m-r font_size px-2 py-1 font_family' type="text" name="" value={title_input1} id="" onChange={(e) => settitle_input1(e.target.value)} />
        ...
        <div className="subtitle mb-2 px-1_5">
            ...
            <input className='border-l-0 border-r-0 border-t-0 outline_line font_size subtitle_input px-2 py-1 font_family' type="text" value={subtitle_input1} name="" id=""onChange={(e) => setSubtitle_input1(e.target.value)} />
        </div>
        <Work/>
      </div>
    </div>
